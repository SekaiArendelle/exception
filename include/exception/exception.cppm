 ...
 * @note experimental support for C++20 module version
 *       requires clang22+
 ...
 */
export template<bool ndebug = false>
#if __has_cpp_attribute(__gnu__::__always_inline__)
[[__gnu__::__always_inline__]]
#elif __has_cpp_attribute(msvc::forceinline)
[[msvc::forceinline]]
...
export struct nullopt_t_ {};

export template<typename T>
using optional = ::exception::expected<T, ::exception::nullopt_t_>;

export using nullopt_t = ::exception::unexpected<::exception::nullopt_t_>;
